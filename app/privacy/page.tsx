          ...
          <section className="space-y-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Ufacedesign collects personal information including but not limited to: name, email address, phone number, shipping address, shoe size preferences, purchase history, and payment information when you make a purchase or create an account on our platform.
              </p>
            </div>
